# Pixel Ecosystem Documentation

Welcome to the master documentation for the Pixel ecosystem.
...
## Development & AI
- [AI SDK 6 Reference](./AI_SDK_6_REFERENCE.md)
- [AI SDK 6 Docs](./AI_SDK_6_DOCS.md)
- [Agent Rules](./syntropy-agents.md)
