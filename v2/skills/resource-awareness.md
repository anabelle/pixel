...
## What it does
Helps Pixel adapt its behavior to current resource constraints. The primary model (GLM-4.7) has rate limits that trigger 429 errors, cascading to Gemini fallbacks. API costs, disk space, and memory are finite. This skill teaches self-awareness about consumption patterns and graceful adaptation.
...
- During heartbeat posts, prefer the simple model path (GLM-4.5-air) — don't overthink posts
